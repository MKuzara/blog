...
namespace Blog.API.Data
{
    ...
    {
        public BlogAPIDbContext(DbContextOptions dbContextOptions) : base(dbContextOptions)
        { 
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            List<User> users = new List<User>() {
                new User() {
                    Id = Guid.Parse("b73ee27e-4084-45ff-b7dd-5a821adef831"),
                    UserName = "example_user_1",
                    Email = "user1@example.com"
                },
                new User() {
                    Id = Guid.Parse("6682b6cc-9ea9-4ff3-92dc-cbd306a31cd4"),
            ...
            List<BlogPost> blogPosts = new List<BlogPost>() {
                new BlogPost() {
                    ...
                    UserId = Guid.Parse("b73ee27e-4084-45ff-b7dd-5a821adef831")
                },
                new BlogPost() {
                    ...
                    CreatedDate = DateTime.UtcNow,
                    UserId = Guid.Parse("6682b6cc-9ea9-4ff3-92dc-cbd306a31cd4")
                },
                new BlogPost() {
